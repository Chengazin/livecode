...
class ProjectSpeechController extends Controller
{
    ...
    public function transcribe(
        ...
        return $this->transcribeWithLocalEngine($audio, $language);
    }

    private function transcribeWithLocalEngine(UploadedFile $audio, ?string $language): JsonResponse
    {
